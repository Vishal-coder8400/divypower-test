...
const HoverVideoCard = () => {
  ...
  return (
    <section className="relative w-full px-4 sm:px-6 lg:px-8 py-16 bg-gradient-to-br from-[#FFF5F0] via-[#FFF9F5] to-[#FFFAF7] overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-4 bg-gradient-to-r from-[#090971] via-[#090971] to-[#0a0a85] bg-clip-text text-transparent leading-tight">
