      ...
      <div className="relative max-w-[75%]">
        <motion.div
          className={`px-4 py-3 rounded-2xl text-sm sm:text-base shadow-md whitespace-pre-line
            ${isRight ? "bg-white text-black rounded-br-none" : "bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-500 text-white rounded-bl-none"}
          `}
          layout
        >
          {typing ? (
            <div className="flex flex-col">
              <p className={`mb-1 text-xs italic ${isRight ? "text-black" : "text-white"}`}>
