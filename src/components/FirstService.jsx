    ...
    return (
        <div className="bg-gray-100 text-white min-h-screen GetfontHome mb-2 mt-0 lg:mt-0 md:mt-0 xl:mt-0 2xl:mt-0">
            ...
            <main className="bg-white text-white rounded-xl shadow-lg max-w-4xl mx-auto p-8 mb-16">
                ...
                <h2 className="text-2xl font-bold text-[#090971] mb-4">Installation & Commissioning <span className="bg-gradient-to-r from-orange-500 via-orange-400 to-yellow-500 bg-clip-text text-transparent">(INC)</span></h2>
